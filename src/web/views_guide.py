...
_METRIC_DETAILS: dict[str, dict] = {
    ...
    "TSB": {"range": "-50~+30", "good": "-10~+10", "warn": "-30~-10", "bad": "<-30 또는 >+25",
            "detail": "CTL - ATL. 양수면 신선(회복), 음수면 피로 축적. "
                      "-10~+10 최적 훈련, +25 이상 탈훈련, -30 이하 과훈련."},
    ...
    "VDOT": {"range": "20~85", "good": "-", "warn": "-", "bad": "-",
             "detail": "Jack Daniels VO2Max 추정치. 레이스 기록에서 역산. "
                       "일반인 30~45, 중급 45~55, 고급 55~65, 엘리트 65+."},
    "DI": {"range": "0~100", "good": ">70", "warn": "40~70", "bad": "<40",
           "detail": "90분+ 장거리 러닝에서 후반부 페이스 유지 비율. "
                     "70 이상 우수, 40 미만이면 후반부 급격히 느려짐."},
    ...
    "eFTP": {"range": "페이스 (sec/km)", "good": "-", "warn": "-", "bad": "-",
             "detail": "약 60분 유지 가능한 최대 페이스. Intervals FTP 또는 "
                       "40~70분 고강도 활동에서 추정."},
    ...
    "MarathonShape": {"range": "0~100%", "good": ">80%", "warn": "60~80%", "bad": "<60%",
                      "detail": "주간 거리 + 최장 거리 vs VDOT 기준 목표 달성률. "
                                "80% 이상 충분한 준비, 60% 미만 훈련 부족."},
}
