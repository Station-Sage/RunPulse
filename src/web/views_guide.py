...
_METRIC_DETAILS: dict[str, dict] = {
    ...
    "eFTP": {"range": "페이스 (sec/km)", "good": "-", "warn": "-", "bad": "-",
             "detail": "약 60분 유지 가능한 역치 페이스. Intervals FTP 우선, "
                       "없으면 최대심박 82%+ 고강도 활동(30~70분)에서 가중 추정."},
    ...
    "MarathonShape": {"range": "0~100%", "good": ">80%", "warn": "60~80%", "bad": "<60%",
                      "detail": "주간 볼륨(50%) + 장거리런(30%) + 일관성(20%) 종합 달성률. "
                                "VDOT 기반 목표: 주간 20+VDOT×0.9km, 장거리 10+VDOT×0.35km. "
                                "80% 이상 레이스 준비 충분."},
}
