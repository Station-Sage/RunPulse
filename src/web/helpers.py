...
METRIC_DESCRIPTIONS: dict[str, str] = {
    ...
    "eFTP": "기능적 역치 페이스 (sec/km). 약 60분 유지 가능한 최대 페이스",
    "REC": "통합 러닝 효율성 (0~100). EF×Decoupling×폼 종합. 높을수록 효율적",
    "TEROI": "훈련 효과 ROI. CTL 변화/투입 TRIMP. 양수=효율적 훈련, 음수=피트니스 하락",
    "RRI": "레이스 준비도 (0~100). VDOT+CTL+DI+CIRS 종합. 80+ 레이스 준비 완료",
