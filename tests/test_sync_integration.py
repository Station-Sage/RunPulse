...
class TestCrossSourceDedup:
    def test_garmin_strava_same_activity(self, db_conn):
        ...
        db_conn.execute(
            """INSERT INTO activities (source, source_id, start_time, distance_km)
    ...
    def test_source_metrics_linked_correctly(self, db_conn):
        ...
        # 각 소스별 지표 삽입
        db_conn.execute(
            "INSERT INTO source_metrics (activity_id, source, metric_name, metric_value) VALUES (1, 'garmin', 'vo2max', 48.5)"
        )
        db_conn.execute(
            "INSERT INTO source_metrics (activity_id, source, metric_name, metric_value) VALUES (2, 'strava', 'suffer_score', 87)"
        )
